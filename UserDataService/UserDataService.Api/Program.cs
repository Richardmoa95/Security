...
using System.Text;
using UserDataService.Application.DependencyInjection;
using UserDataService.Infrastructure.Data;
using UserDataService.Infrastructure.DependencyInjection;
...
namespace UserDataService.Api
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                c.SwaggerDoc("v1", new() { Title = "UserDataService", Version = "v1" });
